...
public class Automovil extends Vehiculo{
	...
	public Automovil (String placa,String nombre,int precio,int peso,Fabricante fabricante, int puestos) { // Se deben llamar todos los parámetros que son ingresados como parámetros
